        ...
        {apps.map((app, index) => {
          ...
          return (
            ...
            >
              {hoveredApp === app.id && (
                <div
                  className="absolute px-2 py-1 bg-gray-800/90 text-white text-xs rounded-md shadow-lg backdrop-blur-sm border border-white/10 pointer-events-none whitespace-nowrap"
                  style={{
                    bottom: '100%',
                    marginBottom: '8px',
                    left: '50%',
